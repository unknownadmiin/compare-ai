      ...
      <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm hover:border-slate-600 transition-colors duration-300">
        <CardHeader className="space-y-1 text-center">
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            <CardTitle className="text-2xl font-bold text-white">Join AI Fiesta</CardTitle>
            <CardDescription className="text-slate-400">Create an account to start comparing AI models</CardDescription>
          </motion.div>
        </CardHeader>
